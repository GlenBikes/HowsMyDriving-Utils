...
describe('Numeric string compare', function() {
  describe('Test strings with a < b', function() {
    it('return < 0', () => {
      assert(
        CompareNumericStrings('1196720038423617536', '1196727525382049792') < 0
      );
    });
  });
  ...
  describe('Test strings with a > b, a shorter', function() {
    it('return > 0', () => {
      assert(
        CompareNumericStrings('1196727525382049792', '1196720038423617536') > 0
      );
    });
  });
  ...
  describe('Test strings with a == b', function() {
    it('return == 0', () => {
      assert(
        CompareNumericStrings('1196727525382049792', '1196727525382049792') == 0
      );
    });
  });
